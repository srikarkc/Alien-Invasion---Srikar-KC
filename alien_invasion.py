...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Alien Invasion - Srikar")
    ...
    def _check_events(self):
        """Respond to key pressess and mouse movements"""
    ...
    def update_bullets(self):
        ...
        # Get rid of the bullets that have crossed the top of the screen
    ...
    def _update_aliens(self):
        ...
        Check if the fleet is at an edge
            then update the position of the aliens in the fleet
        """
